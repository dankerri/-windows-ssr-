...
这篇教程分享给与我合租vps的小伙伴
## 文章更新提醒
文章在2018-08-21进行了更新, 事实上新的客户端有pac也有全局模式所以不再需要浏览器插件配合使用了.
...
2. 压缩包包含以下内容
> - ssr文件夹， ssr的客户端
> - <del>SwitchyOmega.crx， chrome插件文件<del/>
> - <del>GWFList.bak, SwithyOmega.crx的配置文件</del>
...
4. 简单的理解就是在电脑上浏览器可以直接使用ss代理, 其他的软件用ss代理就需要很多额外的步骤
